...
class LoveHadith extends StatefulWidget {
  const LoveHadith({super.key});

  @override
  State<LoveHadith> createState() => _LoveHadithState();
}

class _LoveHadithState extends State<LoveHadith> {
  @override
